...
[Package website](https://gempp.cl/personnelSelectionUtility/){.btn .btn-outline-primary .btn-sm} [<i class="bi bi-box-seam"></i> CRAN](https://cran.r-project.org/package=personnelSelectionUtility){.btn .btn-outline-secondary .btn-sm} [<i class="bi bi-github"></i> GitHub](https://github.com/rgempp/personnelSelectionUtility){.btn .btn-outline-secondary .btn-sm}
...
[Package website](https://gempp.cl/csemGT/){.btn .btn-outline-primary .btn-sm} [<i class="bi bi-box-seam"></i> CRAN](https://CRAN.R-project.org/package=csemGT){.btn .btn-outline-secondary .btn-sm} [<i class="bi bi-github"></i> GitHub](https://github.com/rgempp/csemGT){.btn .btn-outline-secondary .btn-sm}
